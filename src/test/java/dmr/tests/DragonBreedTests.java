 ...
 * registry system, including hybrid breed generation and retrieval.
 */
...
public class DragonBreedTests {
     ...
     * Hybrid breeds are automatically generated from combinations of regular
     * breeds.
     *
     * @param helper
     *               The test helper provided by the game test framework
    ...
    /**
     * Tests that the DragonBreedsRegistry can retrieve a specific hybrid breed by
     * its parent breeds.
     *
     * @param helper
     *               The test helper provided by the game test framework
    ...
    /**
     * Tests that a hybrid breed has the correct properties: 1. It is an instance of
     * DragonHybridBreed 2. It has the correct parent breeds 3. It has the correct
    ...
    public static void verifyHybridProperties(ExtendedGameTestHelper helper) {
        ...
        if (!hybridBreed.parent1.getId().equals("test1")
                || !hybridBreed.parent2.getId().equals("test2")) {
