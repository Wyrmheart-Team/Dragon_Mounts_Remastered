 ...
 * dragon armor types can be properly registered, retrieved, and managed through
 * the registry system.
 */
...
public class DragonArmorTests {
    ...
    /**
     * Tests that the DragonArmorRegistry contains at least one armor type. This
    ...
    /**
     * Tests that the DragonArmorRegistry has a default armor type. The default
    ...
    /**
     * Tests that the DragonArmorRegistry can retrieve the first armor in the
    ...
    /**
     * Tests that the DragonArmorRegistry can retrieve a specific armor by ID and
