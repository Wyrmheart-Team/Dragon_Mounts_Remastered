...
public class EnsureSafeFlyingVehicleMixin {
    ...
    @Redirect(
            ...
            at =
                    @At(
                            value = "FIELD",
                            target =
                                    "Lnet/minecraft/server/network/ServerGamePacketListenerImpl;clientVehicleIsFloating:Z",
    ...
    private void dragonmounts_ensureSafeFlyingVehicle(ServerGamePacketListenerImpl impl, boolean flag) {
        clientVehicleIsFloating =
                (!(impl.getPlayer().getRootVehicle() instanceof FlyingAnimal a) || !a.isFlying()) && flag;
    }
}
