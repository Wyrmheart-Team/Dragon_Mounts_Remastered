...
public class DragonAbilityButton extends ExtendedButton {
    ...
    public DragonAbilityButton(int xPos, int yPos, Ability ability) {
        ...
        if(ability != null) {
            ...
            this.description = ComponentRenderUtils.wrapComponents(ability.getTranslatedDescription().copy(), 120, this.minecraft.font);
    ...
    public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTick) {
        ...
        if(isHovered()) {
            ...
            guiGraphics.drawCenteredString(this.minecraft.font, this.title, getX() + 28 + ((this.width - 28 - 5) / 2), getY() + 8, -1);
