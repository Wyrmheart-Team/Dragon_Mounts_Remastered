...
class BlockTagProvider extends BlockTagsProvider {
	...
	protected void addTags(Provider pProvider)
	{
		...
		tag(NETHER_DRAGON_HABITAT_BLOCKS).addTags(BlockTags.SOUL_FIRE_BASE_BLOCKS, BlockTags.BASE_STONE_NETHER, BlockTags.WARPED_STEMS, BlockTags.CRIMSON_STEMS).add(
				Blocks.GLOWSTONE,
				Blocks.SOUL_FIRE,
		...
		tag(WATER_DRAGON_HABITAT_BLOCKS).addTags(BlockTags.CORALS, BlockTags.WALL_CORALS, BlockTags.CORAL_BLOCKS).add(
				Blocks.SEAGRASS,
