...
public record BiomeHabitat(int points, TagKey<Biome> biomeTag) implements Habitat {
	public static final Codec<BiomeHabitat> CODEC =
			RecordCodecBuilder.create(instance -> instance.group(Habitat.withPoints(2, BiomeHabitat::points), TagKey.codec(Registries.BIOME).fieldOf("biome_tag").forGetter(BiomeHabitat::biomeTag))
