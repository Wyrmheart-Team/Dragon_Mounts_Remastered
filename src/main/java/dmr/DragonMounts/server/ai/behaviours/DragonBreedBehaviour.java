...
public class DragonBreedBehaviour extends Behavior<TameableDragonEntity> {
    ...
    private Optional<TameableDragonEntity> findValidBreedPartner(TameableDragonEntity p_dragon) {
        var entities = p_dragon.getBrain()
                .getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
                .get();
        return entities.findClosest(
                        livingEntity -> livingEntity instanceof TameableDragonEntity dragon && p_dragon.canMate(dragon))
