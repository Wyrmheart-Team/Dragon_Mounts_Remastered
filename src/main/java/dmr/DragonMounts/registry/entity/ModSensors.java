...
public class ModSensors {
    ...
    public static final DeferredRegister<SensorType<?>> SENSORS =
            DeferredRegister.create(Registries.SENSOR_TYPE, DMR.MOD_ID);
    public static final Supplier<SensorType<DragonAttackablesSensor>> DRAGON_ATTACKABLES =
            register("dragon_attackables", DragonAttackablesSensor::new);
