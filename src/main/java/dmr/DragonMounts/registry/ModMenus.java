...
public class ModMenus {
    ...
    public static final Supplier<MenuType<DragonContainerMenu>> DRAGON_MENU =
            MENU_TYPES.register("dragon_menu", () -> IMenuTypeExtension.create(DragonContainerMenu::new));
}
