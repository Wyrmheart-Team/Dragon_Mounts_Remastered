...
public class ModCriterionTriggers {
	...
	public static final DeferredRegister<CriterionTrigger<?>> CRITERION_TRIGGERS = DeferredRegister.create(
	...
	public static final Supplier<HatchCountTrigger> HATCH_COUNT_TRIGGER = CRITERION_TRIGGERS.register(
		"hatch_count",
		HatchCountTrigger::new
	);
