...
public class DMRBlockEntities
{
	...
	public static final Supplier<BlockEntityType<DragonEggBlockEntity>> DRAGON_EGG_BLOCK_ENTITY = BLOCK_ENTITIES.register("dragon_egg", () -> BlockEntityType.Builder.of(DragonEggBlockEntity::new, DMRBlocks.DRAGON_EGG_BLOCK.get()).build(null));
}
