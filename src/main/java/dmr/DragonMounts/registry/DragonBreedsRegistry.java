...
public class DragonBreedsRegistry {
    ...
    public static void registerHybrids() {
        ...
        var list = DRAGON_TYPES.entrySet().stream()
                .filter(ent -> ent.getValue() instanceof DragonHybridBreed)
                .map(Entry::getKey);
    ...
    public static ArrayList<IDragonBreed> getEggOutcomes(
    ...
    public static List<IDragonBreed> getBreeds(TameableDragonEntity tameableDragonEntity) {
        ...
        if (tameableDragonEntity.getBreed() instanceof DragonHybridBreed hybridBreed) {
