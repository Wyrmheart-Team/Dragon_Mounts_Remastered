...
public class DMRComponents {
	public static final DeferredRegister.DataComponents COMPONENTS = DeferredRegister.createDataComponents(Registries.DATA_COMPONENT_TYPE, DragonMountsRemaster.MOD_ID);
	
	public static final Supplier<DataComponentType<String>> DRAGON_BREED = register("dragon_breed", Codec.STRING, ByteBufCodecs.STRING_UTF8);
