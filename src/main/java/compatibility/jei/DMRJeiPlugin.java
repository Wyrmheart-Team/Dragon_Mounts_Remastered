...
public class DMRJeiPlugin implements IModPlugin {
    ...
    public static void addNetheriteArmorRecipe(List<RecipeHolder<CraftingRecipe>> recipes) {
        ...
        var netheriteArmorRecipe = new ShapelessRecipe(
                "dragon",
                CraftingBookCategory.MISC,
                result,
                NonNullList.of(Ingredient.EMPTY, Ingredient.of(diamondArmor), Ingredient.of(Items.NETHERITE_INGOT)));
        var netheriteArmorRecipeHolder =
                new RecipeHolder<CraftingRecipe>(DMR.id("netherite_armor_recipe"), netheriteArmorRecipe);
    ...
    public static void addBlankDragonEggRecipe(List<RecipeHolder<CraftingRecipe>> recipes) {
        ...
        var eggRecipe = new ShapelessRecipe(
                "dragon",
                CraftingBookCategory.MISC,
                result,
                NonNullList.of(Ingredient.EMPTY, Ingredient.of(ModItems.DRAGON_EGG_BLOCK_ITEM.get())));
